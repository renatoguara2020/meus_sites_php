...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-info">Nova Especialidade</a>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					//BUSCAR DADOS DO REGISTRO A SER EDITADO
						$res = $pdo->query("select * from especialidaddes where id = '$id_reg'");
