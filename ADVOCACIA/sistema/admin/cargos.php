...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-info">Novo Cargo</a>
	...
	<div class="col-md-6 col-sm-12">
		...
		<div class="float-right mr-4">
			<form id="frm" class="form-inline my-2 my-lg-0" method="post">
				...
				<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Cargo" aria-label="Search" name="txtbuscar" id="txtbuscar">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					//BUSCAR DADOS DO REGISTRO A SER EDITADO
						$res = $pdo->query("select * from cargos where id = '$id_reg'");
						$dados = $res->fetchAll(PDO::FETCH_ASSOC);
						$nome = $dados[0]['nome'];

						

						echo 'Edição de Cargos';
					}else{
						$nome_botao = 'Salvar';
						echo 'Cadastro de Cargos';
					} ?>
				</h5>
			...
			<div class="modal-body">
				...
				<form method="post">
							...
							<div class="form-group">
								...
								<input type="hidden" id="antigo"  name="antigo" value="<?php echo @$nome ?>" required>
